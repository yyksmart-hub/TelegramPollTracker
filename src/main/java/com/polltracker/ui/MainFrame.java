...
public class MainFrame extends JFrame {
    ...
    public MainFrame(CommunityService communityService, SurveyService surveyService, GeminiService geminiService) {
        ...
        tabbedPane.addTab("ניהול סקרים", new SurveyPanel(surveyService, geminiService));
